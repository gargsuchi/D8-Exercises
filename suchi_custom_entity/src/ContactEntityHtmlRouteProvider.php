...
/**
 * @file
 * Contains \Drupal\suchi_custom_entity\ContactEntityHtmlRouteProvider.
 */
...
class ContactEntityHtmlRouteProvider extends AdminHtmlRouteProvider {
  ...
  protected function getAddFormRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('add-form')) {
      ...
      $route
        ->setDefaults([
          '_controller' => 'Drupal\suchi_custom_entity\Controller\ContactEntityAddController::addForm',
          '_title_callback' => 'Drupal\suchi_custom_entity\Controller\ContactEntityAddController::getAddFormTitle',
        ])
  ...
  protected function getAddPageRoute(EntityTypeInterface $entity_type) {
    ...
    $route
      ->setDefaults([
        '_controller' => 'Drupal\suchi_custom_entity\Controller\ContactEntityAddController::add',
  ...
  protected function getSettingsFormRoute(EntityTypeInterface $entity_type) {
    if (!$entity_type->getBundleEntityType()) {
      ...
      $route
        ->setDefaults([
          '_form' => 'Drupal\suchi_custom_entity\Form\ContactEntitySettingsForm',
