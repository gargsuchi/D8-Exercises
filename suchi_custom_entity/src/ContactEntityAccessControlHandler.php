...
/**
 * @file
 * Contains \Drupal\suchi_custom_entity\ContactEntityAccessControlHandler.
 */
 ...
 *
 * @see \Drupal\suchi_custom_entity\Entity\ContactEntity.
 */
class ContactEntityAccessControlHandler extends EntityAccessControlHandler {
  ...
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    /** @var \Drupal\suchi_custom_entity\ContactEntityInterface $entity */
    switch ($operation) {
      case 'view':
